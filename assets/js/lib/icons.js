...
NA.icons = (function () {
  ...
  const SYMBOLS = {
    ...
    /* ---- redes sociais ---- */
    'i-whatsapp':  [V24, '<path d="M12.04 2c-5.46 0-9.9 4.44-9.9 9.9 0 1.75.46 3.45 1.33 4.95L2.05 22l5.3-1.38a9.87 9.87 0 0 0 4.69 1.19h.004c5.46 0 9.9-4.44 9.9-9.9 0-2.64-1.03-5.13-2.9-7a9.82 9.82 0 0 0-7-2.9Zm0 1.67c2.2 0 4.27.86 5.82 2.42a8.2 8.2 0 0 1 2.41 5.82c0 4.54-3.7 8.23-8.24 8.23a8.2 8.2 0 0 1-4.19-1.15l-.3-.18-3.12.82.83-3.05-.2-.31a8.18 8.18 0 0 1-1.26-4.38c0-4.54 3.7-8.23 8.25-8.23Zm-3 3.8c-.14 0-.37.05-.56.26-.2.21-.75.73-.75 1.78 0 1.05.77 2.07.87 2.21.1.14 1.5 2.3 3.65 3.22.51.22.9.35 1.22.45.51.16.98.14 1.35.09.41-.06 1.27-.52 1.45-1.02.18-.5.18-.93.13-1.02-.05-.09-.2-.14-.41-.25-.22-.1-1.27-.62-1.46-.7-.2-.07-.34-.1-.48.11-.14.21-.55.7-.68.84-.12.14-.25.16-.46.05-.22-.1-.91-.33-1.73-1.06a6.5 6.5 0 0 1-1.2-1.49c-.12-.21-.01-.33.1-.44.1-.1.21-.25.32-.38.1-.12.14-.21.21-.35.07-.15.04-.27-.02-.38-.05-.1-.48-1.16-.66-1.59-.17-.42-.35-.36-.48-.37h-.4Z" fill="currentColor" stroke="none"/>'],
